...
def gen_det_label(root_path, input_dir, out_label):
    with open(out_label, 'w') as out_file:
        for label_file in os.listdir(input_dir):
            ...
            label = []
            with open(
                    # os.path.join(input_dir, label_file), 'r',encoding='utf-8') as f:
                os.path.join(input_dir, label_file), 'r',encoding='utf-8-sig') as f:
                for line in f.readlines():
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--root_path',
        type=str,
        default=r"E:\2015data\data\ch4_training_images",
        help='The root directory of images.Only takes effect when mode=det ')
    parser.add_argument(
        '--input_path',
        type=str,
        default=r"E:\2015data\data\ch4_training_localization_transcription_gt",
        help='Input_label or input path to be converted')
    parser.add_argument(
        '--output_label',
        type=str,
        default="train_icdar2015_label.txt",
