...
def voc2yolo(filename):
    classes_dict = {}
    with open(r"E:\workspace\datasets\classes.txt") as f:
...
if __name__ == "__main__":
    xml_path_list = glob.glob(r"E:\workspace\20230420\xml/*.xml")
    for xml_path in xml_path_list:
        voc2yolo(xml_path)
 
 
    imglist = get_image_list(r"E:\workspace\20230419\img")
