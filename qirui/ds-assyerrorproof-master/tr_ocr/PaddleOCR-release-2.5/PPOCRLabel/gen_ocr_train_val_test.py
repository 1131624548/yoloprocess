...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--datasetRootPath",
        type=str,
        default="E:/workspace/ocr/PaddleOCR-release-2.5/mydata",
        help="path to the dataset marked by ppocrlabel, E.g, dataset folder named 1,2,3..."
    )
    parser.add_argument(
        "--detRootPath",
        type=str,
        default="E:/workspace/ocr/PaddleOCR-release-2.5/mydata/det",
        help="the path where the divided detection dataset is placed")
    parser.add_argument(
        "--recRootPath",
        type=str,
        default="E:/workspace/ocr/PaddleOCR-release-2.5/mydata/rec",
        help="the path where the divided recognition dataset is placed"
    )
    parser.add_argument(
        "--detLabelFileName",
        type=str,
        default="E:/workspace/ocr/PaddleOCR-release-2.5/mydata/Label.txt",
        help="the name of the detection annotation file")
    parser.add_argument(
        "--recLabelFileName",
        type=str,
        default="E:/workspace/ocr/PaddleOCR-release-2.5/mydata/rec_gt.txt",
        help="the name of the recognition annotation file"
    )
    parser.add_argument(
        "--recImageDirName",
        type=str,
        default="E:/workspace/ocr/PaddleOCR-release-2.5/mydata/crop_img",
