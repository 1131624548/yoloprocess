...
if __name__ == "__main__":
    # ------ 更改测试数据 ------ #
    # data_path = r'E:\data\car_hub\chebiao\chebiao2_1_yin.png' # 获取图像文件的相对路径，可以是单张图片，也可以是图片数据集
    image_path = r'C:\Users\Dell\Desktop\task\10.png' # 获取图像文件的相对路径，可以是单张图片，也可以是图片数据集

    # 接将path下所有图片加载
    # img_path_list = []
    # basedir = os.path.abspath(os.path.dirname(__file__))  # 获取当前文件的绝对路径
    basedir = r'C:\Users\Dell\Desktop\task'  # 获取当前文件的绝对路径
    ...
    # 过滤识别结果
    print(ocr_results)
    # filter_ocr_results([basedir], ocr_results)
